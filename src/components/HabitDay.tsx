                ...
                <Popover.Content className='min-w-[320px] p-6 rounded-2xl bg-zinc-900 flex flex-col'>
                    ...
                    <div className='mt-6 flex flex-col gap-3'>
                        ...
                        >
                            ...
                            <span className='font-semibold text-white leading-tight group-data-[state=checked]:line-through group-data-[state=checked]:text-zinc-400'>Beber 2L de água</span>
                        </Checkbox.Root>
