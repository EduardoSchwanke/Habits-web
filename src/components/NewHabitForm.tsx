...
import { ArchiveTray, Check } from "phosphor-react";
...
export function NewHabitForm() {
    ...
    function handleToggleWeekDay(weekDay: number) {
        if(weekDays.includes(weekDay)){
            ...
            const weekDayWithAddOne = [...weekDays, weekDay]

            setWeekDays(weekDayWithAddOne)
        }
    }
    ...
    return (
        <form onSubmit={createNewHabit} className="w-full flex flex-col mt-6">
                    ...
                    availableWeekDays.map( (day, index) => {
                        return(
                            ...
                            >
                                ...
                                <span className='text-white leading-tigh'>{day}</span>
                            </Checkbox.Root>
                        )
                    })
                }
            ...
            <button type="submit" className="mt-6 rounded-lg p-4 flex gap-3 items-center font-semibold bg-green-600 justify-center hover:bg-green-500 transition-all focus:outline-none focus:ring-2 focus:ring-green-600 focus:ring-offset-2 focus:ring-offset-zinc-900">
